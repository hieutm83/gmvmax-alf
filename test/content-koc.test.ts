...
describe('Content & KOC analysis', () => {
  ...
  it('keeps seller, KOC and Ads-only totals separate', () => {
    const totals = calculateContentKocTotals([
      { creatorType:'SELLER', isPostedInRange:true, shop:{gmv:1_000,views:100,clicks:5,skuOrders:2}, ads:{cost:200,grossRevenue:1_000,productClicks:3,productImpressions:30} },
      { creatorType:'KOC', isPostedInRange:true, shop:{gmv:2_000,views:300,clicks:12,skuOrders:4}, ads:{cost:0,grossRevenue:2_000} },
      { creatorType:'UNKNOWN', isPostedInRange:true, shop:null, ads:{cost:50,grossRevenue:0,orders:1,productClicks:2,productImpressions:20} }
    ]);
