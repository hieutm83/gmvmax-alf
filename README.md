...
- `TIKTOK_SHOP_SERVICE_ID` chi bat buoc neu muon tao authorization link tu nut tren web. Neu cap quyen truc tiep trong Partner Center thi callback se xac minh bang `app_key`.
